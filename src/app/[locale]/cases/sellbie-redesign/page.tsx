...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description:
        'Redesign do core de campanhas multicanal da Sellbie.',
...
function Eyebrow({ children }: { children: React.ReactNode }) {
  return (
    <p className="type-caption text-fg-subtle mb-4">{children}</p>
  );
}

function SectionHeading({ children }: { children: React.ReactNode }) {
  return (
    <h2 className="type-headline text-fg mb-6">{children}</h2>
  );
}
          ...
          <div className="max-w-5xl mx-auto space-y-24">
            ...
            <section className="space-y-8">
              ...
              <CaseBento
                ...
                images={[
                  {
                    src: '/images/cases/sellbie/redesign/sellbie-redesign-navegacao-antes-2.png',
                    alt: 'Padrão superior de navegação',
                    caption: 'Padrão superior',
                  },
                  {
                    src: '/images/cases/sellbie/redesign/sellbie-redesign-navegacao-antes-3.png',
                    alt: 'Padrão lateral de navegação',
                    caption: 'Padrão lateral',
                  },
                ]}
                accentBg={ACCENT_BG}
            ...
            {/* ── 3. Campanhas — o sintoma mais visível ─── */}
            <section className="space-y-8">
              <div>
            ...
            <section className="space-y-8">
              ...
              <CaseBento
                ...
                images={[
                  {
                    src: '/images/cases/sellbie/redesign/sellbie-redesign-criacao-envio-antes-2.png',
                    alt: 'Etapa 2 do fluxo antigo',
                    caption: 'Etapa 2 do fluxo antigo',
                  },
                  {
                    src: '/images/cases/sellbie/redesign/sellbie-redesign-criacao-envio-antes-3.png',
                    alt: 'Etapa 3 — base densa sem resumo',
                    caption: 'Etapa 3 — base densa sem resumo',
                  },
                ]}
                accentBg={ACCENT_BG}
                accentText={ACCENT_TEXT}

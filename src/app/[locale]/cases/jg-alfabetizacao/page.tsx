          ...
          >
              ...
              <section className="space-y-8">
                ...
                <CaseBento
                  ...
                  images={[
                    { src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-slide-silabico.png', alt: 'Fase Silábica', caption: 'Fase Silábica' },
                    { src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-slide-alfabetico.png', alt: 'Fase Alfabética', caption: 'Fase Alfabética' },
                  ]}
                  accentBg={ACCENT_BG}
                  accentText={ACCENT_TEXT}
                />
              ...
              <section className="space-y-8">
                ...
                <CaseBento
                  ...
                  images={[
                    { src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-modelo-multipla-escolha.png', alt: 'Modelo de múltipla escolha', caption: 'Múltipla Escolha' },
                    { src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-modelo-correlacao-ordenacao-vertical.png', alt: 'Modelo de correlação e ordenação vertical', caption: 'Correlação / Ordenação Vertical' },
                  ]}
                  accentBg={ACCENT_BG}
                  accentText={ACCENT_TEXT}
                />
              ...
              <section className="space-y-8">
                ...
                <CaseBento
                  ...
                  images={[
                    { src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-modelo-motricidade.png', alt: 'Modelo de motricidade', caption: 'Motricidade' },
                    { src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-modelo-abaco.png', alt: 'Modelo de ábaco', caption: 'Ábaco' },
                  ]}
                  accentBg={ACCENT_BG}
                  accentText={ACCENT_TEXT}
                />
              ...
              <section className="space-y-8">
                ...
                <CaseBento
                  ...
                  images={[
                    { src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-org-fases.png', alt: 'Organização de atividades por fase', caption: 'Atividades por fase' },
                  ]}
                  accentBg={ACCENT_BG}
                  accentText={ACCENT_TEXT}
                />

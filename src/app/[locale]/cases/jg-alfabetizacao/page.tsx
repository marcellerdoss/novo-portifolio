...
import { CaseZoom } from '@/components/case/CaseZoom';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description:
        'Sistema de fases, matriz de proficiência e modelos de questão para alfabetização no Jovens Gênios.',
        ...
        <article className="py-section px-6 space-y-24">
          <div className="max-w-5xl mx-auto space-y-24">
            ...
            <section className="space-y-8">
              ...
              <CaseHero
                imageSrc="/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-slide-progressao.png"
                imageAlt="Fases de alfabetização mapeadas por ano escolar"
            ...
            <section className="space-y-8">
              ...
              {/* [imagem: fases-overview] */}
              <CaseLightbox
                imageSrc="/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-slide-fases.png"
                imageAlt="Quatro fases de alfabetização — mapa pedagógico"
            ...
            <section className="space-y-8">
              ...
              {/* [imagem: slides-fases] */}
              <CaseBento
                mainImage="/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-slide-pre-silabico.png"
                mainAlt="Fase Pré-silábica com atividades e lacunas"
                mainCaption="Fase Pré-silábica — atividades e lacunas antes de qualquer tela"
                images={[
                  {
                    src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-slide-silabico.png',
                    alt: 'Fase Silábica',
                    caption: 'Fase Silábica',
                  },
                  {
                    src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-slide-alfabetico.png',
                    alt: 'Fase Alfabética',
                    caption: 'Fase Alfabética',
                  },
                ]}
                accentBg={ACCENT_BG}
                accentText={ACCENT_TEXT}
            ...
            <section className="space-y-8">
              ...
              {/* [imagem: tabela-codigo] */}
              <CaseEditorial
                imageSrc="/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-tabela-codigo-fases.png"
                imageAlt="Tabela de código de fases — linguagem operacional compartilhada"
                title="Uma linguagem comum para três times"
                body="Código de fases — linguagem operacional compartilhada entre design, pedagogia e tecnologia."
                reverse={false}
                accentBg={ACCENT_BG}
                accentText={ACCENT_TEXT}
              />
            ...
            <section className="space-y-8">
              ...
              {/* [imagem: matriz] */}
              <CaseLightbox
                imageSrc="/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-matriz-proficiencia.png"
                imageAlt="Matriz de proficiência com habilidades da BNCC por fase"
            ...
            <section className="space-y-8">
              ...
              {/* [imagem: esquema-modelos] */}
              <CaseZoom
                imageSrc="/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-esquema-matriz-modelos.png"
                imageAlt="Esquema de matriz de modelos de questão"
                zoomLabel="código de modelo"
                zoomPosition="center"
                markerStyle={{ top: '28%', left: '18%', width: '38%', height: '32%' }}
                accentBg={ACCENT_BG}
                accentText={ACCENT_TEXT}
              />
            </section>
            ...
            <section className="space-y-8">
              ...
              {/* [imagem: modelos-questao-1] */}
              <CaseBento
                mainImage="/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-modelo-ordenacao-horizontal.png"
                mainAlt="Modelo de ordenação horizontal em três fases"
                mainCaption="Ordenação Horizontal — um modelo, três fases, múltiplas variações"
                images={[
                  {
                    src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-modelo-multipla-escolha.png',
                    alt: 'Modelo de múltipla escolha',
                    caption: 'Múltipla Escolha',
                  },
                  {
                    src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-modelo-correlacao-ordenacao-vertical.png',
                    alt: 'Modelo de correlação e ordenação vertical',
                    caption: 'Correlação / Ordenação Vertical',
                  },
                ]}
                accentBg={ACCENT_BG}
                accentText={ACCENT_TEXT}
            ...
            <section className="space-y-8">
              ...
              {/* [imagem: modelos-questao-2] */}
              <CaseBento
                mainImage="/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-modelo-producao-textual.png"
                mainAlt="Modelo de produção textual como etapa final"
                mainCaption="Produção Textual — escrita estruturada como etapa final"
                images={[
                  {
                    src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-modelo-motricidade.png',
                    alt: 'Modelo de motricidade',
                    caption: 'Motricidade',
                  },
                  {
                    src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-modelo-abaco.png',
                    alt: 'Modelo de ábaco',
                    caption: 'Ábaco',
                  },
                ]}
            ...
            <section className="space-y-8">
              ...
              {/* [imagem: modelos-questao-3] */}
              <CaseBento
                mainImage="/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-modelo-ditado.png"
                mainAlt="Modelo de ditado para diferentes fases"
                mainCaption="Ditado — escuta e escrita para diferentes fases"
                images={[
                  {
                    src: '/images/cases/jovens-genios/alfabetizacao/jg-alfabetizacao-org-fases.png',
                    alt: 'Organização de atividades por fase',
                    caption: 'Atividades por fase',
                  },
                ]}
                accentBg={ACCENT_BG}
                accentText={ACCENT_TEXT}

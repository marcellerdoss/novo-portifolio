          ...
          >
              ...
              <section className="space-y-8">
                ...
                <CaseBento
                  ...
                  images={[
                    { src: '/images/cases/sellbie/jornadas/sellbie-jornadas-canal-whatsapp.png', alt: 'Canal WhatsApp 1:1 pelo vendedor', caption: 'WhatsApp 1:1 pelo vendedor' },
                    { src: '/images/cases/sellbie/jornadas/sellbie-jornadas-canal-sms.png', alt: 'Canal SMS com restrições explícitas', caption: 'SMS — restrições explícitas' },
                  ]}
                  accentBg={ACCENT_BG}
                  accentText={ACCENT_TEXT}
                />

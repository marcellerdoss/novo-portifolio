...
const productCards: {
  ...
  },
  {
    ...
    description: {
      pt: 'Canvas de fluxo com 20+ gatilhos, múltiplos canais e lógica comportamental',
      en: 'Flow canvas with 20+ triggers, multiple channels and behavioral logic',
    },
  ...
  },
  {
    ...
    category: { pt: 'Product Design', en: 'Product Design' },
    title: {
      pt: 'JG Alfabetização: sistema pedagógico e modelos de questão',
      en: 'JG Literacy: pedagogical system and question types',
    },
    description: {
      pt: 'Fases, modelos de questão e matriz de proficiência para IA adaptativa',
      en: 'Phases, question types and proficiency matrix for adaptive AI',
    },
  ...
  },
  {
    ...
    description: {
      pt: 'Três perfis, busca filtrada e empty states que mantêm o usuário no caminho',
      en: 'Three profiles, filtered search and empty states that keep users on track',
    },
...
const strategyCards: {
...
}[] = [
  {
    ...
    label: { pt: 'Strategy', en: 'Strategy' },
    title: { pt: 'Métricas de produto com HEART', en: 'Product metrics with HEART' },
  ...
  },
  {
    ...
    category: { pt: 'Relatório estratégico', en: 'Strategic report' },
    label: { pt: 'Strategy', en: 'Strategy' },
    title: { pt: 'Cashback: Relatório de ROAS', en: 'Cashback: ROAS report' },

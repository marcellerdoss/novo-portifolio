            ...
            <motion.div variants={stagger} className="flex flex-wrap gap-4">
              {links.map(({ key, href, icon, label }) => (
                <motion.a
                  ...
                  title={label}
                  variants={fadeInUp}
                  className="group flex items-center justify-center p-3 rounded-lg bg-transparent transition-all duration-150 hover:-translate-y-[3px] hover:bg-white/10 text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
                >
                  {icon}
                </motion.a>
              ))}

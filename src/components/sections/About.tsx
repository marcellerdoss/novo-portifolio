    ...
    >
      <div className="max-w-6xl mx-auto px-6 w-full">
        <div className="grid grid-cols-1 md:grid-cols-[260px_1fr] gap-8 md:gap-14 md:items-center">
          ...
          {/* Left — photo, fixed width at its natural ratio (never crops) */}
          <motion.div
            variants={fadeIn}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
            className="relative w-full md:max-w-[260px] aspect-[3/4] rounded-lg overflow-hidden border border-black/10 dark:border-white/10"
          >
            <Image
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="flex items-center gap-6">
              ...
              <LinkButton href="/#contato" variant="ghost" size="sm">
                {t('cta_connect')}

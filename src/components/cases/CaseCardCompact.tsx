            ...
            <div className="absolute inset-4 flex items-center justify-center">
              {mockup === 'mobile' && (
                ...
                >
                  ...
                  <Image src={imageSrc} alt={imageAlt} fill sizes="33vw" loading="eager" className="object-cover object-top" />
                </div>
              )}
              {mockup === 'desktop' && (
                <div
              ...
              {!mockup && (
                <div className="absolute inset-0">
                  <Image src={imageSrc} alt={imageAlt} fill sizes="33vw" loading="eager" className="object-cover object-left-top" />
                  {company && (
                    <span className="absolute top-3 right-3 type-caption text-fg-subtle">{company}</span>
                  )}
                </div>
